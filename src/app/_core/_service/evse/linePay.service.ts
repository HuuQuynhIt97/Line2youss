...
export class LinePayService extends CURDService<XuserLine>{
  ...
  createPayment(data) {
    return this.http.post(`${this.baseUrl}LinePay/Create`, data);
  }
  confirmPayment(transactionId,orderId,data) {
    return this.http.post(`${this.baseUrl}LinePay/Confirm?transactionId=${transactionId}&orderId=${orderId}`, data);
  }
