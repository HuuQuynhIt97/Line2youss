...
@Component({
  selector: 'app-home-user-anonymous',
  templateUrl: './home-user-anonymous.component.html',
  styleUrls: ['./home-user-anonymous.component.css']
})
export class HomeUserAnonymousComponent implements OnInit {
