...
@Component({
  selector: 'app-home-boss-cart',
  templateUrl: './home-boss-cart.component.html',
  styleUrls: ['./home-boss-cart.component.scss']
})
export class HomeBossCartComponent implements OnInit {
  ...
  orderNow(item){
    ...
    this.router.navigate([`mobile/home-boss/cart-order/${item.guid}`])
  }
  safeHtml(html) {
